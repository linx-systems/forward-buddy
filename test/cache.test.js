...
import { getCachedDomains, setCachedDomains, getCachedAliases, setCachedAliases, invalidateAliases, invalidateAll, updateCachedAlias, removeCachedAlias, } from '../lib/cache.js';
beforeEach(() => {
    invalidateAll();
});
/* ====== Domain cache ====== */
